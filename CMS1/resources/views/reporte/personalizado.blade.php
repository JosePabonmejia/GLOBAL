...
<div class="header pb-6 pt-1 pt-md-6">
    ...
    <div class="container-fluid mt--9">
        <div class="row justify-content-end">
            <form action="{{ route('reporte.find') }}" method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-3">
                                <input class="form-control form-control-sm" type="date" name="fechainicio" required autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group input-group-alternative mb-3">
                                <input class="form-control form-control-sm" type="date" name="fechafin" required autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header border-0">
                        <h2 class="mb-0 text-center">Lista de Pedidos Filtro Personalizado</h2>
                    </div>
